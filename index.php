...
<body>
<a class="btn btn-danger" href="ready/index.php" tooltip="PHP Ajax CRUD without page reload with Bootstrap Modal (Pop up box) using jQuery, PHP Ajax">GO</a>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped" id="myTableOne">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>First Name</th>
